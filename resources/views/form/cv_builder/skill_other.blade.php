...
<div class="form-step hidden" id="step5">
    <form action="{{ route('storeTestSkillOther', ['username' => $doc->user->username, 'document' => $doc->id])}}" method="post" id="stepForm5">
        @csrf
                    ...
                    <div class="rounded border border-sky-100 mb-4">
                        <div class="mb-2">
                            ...
                            <div class="flex items-center w-full mb-2">
                                ...
                                <input type="text" name="skill_other_title" id="skill_other_title" class="w-full h-10 rounded pl-4 @error('skill_other_title') border-2 border-red-500 @enderror" value="{{ old('skill_other_title', $doc->skillOther ? $doc->skillOther->title : '') }}">
                            ...
                            <div class="pl-6 w-full">
                                <textarea name="skill_other_description" id="skill_other_description" class="w-full rounded pl-4 py-2 pr-2">{{ old('skill_other_description', $doc->skillOther ? $doc->skillOther->description : '') }}</textarea>
