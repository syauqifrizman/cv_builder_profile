...
<div class="form-step" id="step1">
    ...
    <form action="{{ route('storePersonal', ['username' => $doc->user->username, 'document' => $doc->id]) }}" method="post" id="stepForm1">
        @csrf
        ...
        <div class="bg-sky-50 mt-6 pr-6 pl-6 mb-6 rounded-md">
            <div class="container-form">
                ...
                <div class="mt-4">
                    ...
                    <input required type="text" name="personal_location" id="personal_location" placeholder="Insert your current location, e.g. Jakarta Barat, Indonesia" class="w-full h-10 rounded pl-4 @error('personal_location') border-2 border-red-500 @enderror" value="{{ old('personal_location', $doc->personal ? $doc->personal->domicile : '') }}">
                ...
                <div class="mt-4">
                    ...
                    <input required type="email" name="personal_email" id="personal_email" placeholder="Insert your active email, e.g. syauqi@gmail.com" class="w-full h-10 rounded pl-4 @error('personal_email') border-2 border-red-500 @enderror" value="{{ old('personal_email', $doc->personal ? $doc->personal->email : '') }}">
                ...
                <div class="mt-4">
                    ...
                    <input required type="tel" name="personal_number" id="personal_number" placeholder="Insert your active phone number, e.g. +62822612345" class="w-full h-10 rounded pl-4 @error('personal_number') border-2 border-red-500 @enderror" value="{{ old('personal_number', $doc->personal ? $doc->personal->phone_number : '') }}">
                ...
                <div class="mt-4">
                    ...
                    <input required type="url" name="personal_linkedin" id="personal_linkedin" placeholder="Insert your linkedin profile url, e.g. https://linkedin.com/in/syauqi" class="w-full h-10 rounded pl-4 @error('personal_linkedin') border-2 border-red-500 @enderror" value="{{ old('personal_linkedin', $doc->personal ? $doc->personal->linkedin_url : '') }}">
                ...
                <div class="mt-4">
                    ...
                    <input type="url" name="personal_portofolio" id="personal_portofolio" placeholder="Insert your portofolio/website url, e.g. https://github.com/syauqi" class="w-full h-10 rounded pl-4 @error('personal_portofolio') border-2 border-red-500 @enderror" value="{{ old('personal_portofolio', $doc->personal ? $doc->personal->portofolio_url : '') }}">
            ...
            <div class="mt-5 pb-5 flex justify-end items-end">
                ...
                <button type="button" id="save" onclick="nextStep()" class="bg-sky-800 text-white rounded-md px-6 py-2 ml-4 border border-sky-800 hover:bg-sky-700">Save & Next</button>
            </div>
        </div>
    </form>
</div>
