        ...
        <form action="{{ route('store_experience', ['username' => $doc->user->username, 'document' => $doc->id]) }}" method="post" id="stepForm2">
            ...
            <div class="bg-sky-50 mt-6 pr-6 pl-6 mb-6 rounded-md">
                ...
                <div class="mt-5 pb-5 flex justify-end items-end">
                    ...
                    <button type="button" id="prevBtn" onclick="window.location.href='{{ route('detail_personal', ['username' => $doc->user->username, 'document' => $doc->id, 'type' => 'update']) }}'" class="bg-sky-800 text-white rounded-md px-6 py-2 ml-4 border border-sky-800 hover:bg-sky-700">Back</button>
