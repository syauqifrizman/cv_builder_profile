...
@section('cv_form')
    ...
    <div class="form-step" id="step2">
        <form action="{{ route('store_experience', ['username' => $doc->user->username, 'document' => $doc->id]) }}" method="post" id="stepForm2">
            @csrf
            ...
            <div class="bg-sky-50 mt-6 pr-6 pl-6 mb-6 rounded-md">
                            ...
                            <div class="rounded border border-sky-100 mb-4">
                                ...
                                <div class="mt-4 flex justify-between gap-6">
                                    <div class="w-1/2">
                                        ...
                                        <input type="date" name="experience_company_start_date" id="experience_company_start_date" class="w-full h-10 rounded pl-4 @error('experience_company_start_date') border-2 border-red-500 @enderror" value="{{ old('experience_company_start_date', $experience->start_date) }}">
                                    ...
                                    <div class="w-1/2">
                                        ...
                                        <input type="date" name="experience_company_end_date" id="experience_company_end_date" class="w-full h-10 rounded pl-4 @error('experience_company_end_date') border-2 border-red-500 @enderror" value="{{ old('experience_company_end_date', $experience->end_date) }}">
                ...
                <div class="mt-5 pb-5 flex justify-end items-end">
                    ...
                    <button type="button" id="prevBtn" class="bg-sky-800 text-white rounded-md px-6 py-2 ml-4 border border-sky-800 hover:bg-sky-700">Back</button>

                    <button type="submit" id="nextBtn" class="bg-sky-800 text-white rounded-md px-6 py-2 ml-4 border border-sky-800 hover:bg-sky-700">Next</button>
                </div>
            </div>
        </form>
    </div>
