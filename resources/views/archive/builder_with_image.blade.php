            ...
            <div>
                ...
                <div class="bg-sky-50 mt-6 pr-6 pl-6 mb-6 rounded-md">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea rows="5" name="input" id="deskripsi" placeholder="Masukkan deskripsi singkat tentang dirimu, e.g. Saya Syauqim mahasiswa tingkat akhir program studi Computer Science peminatan Software Engineering dari Universitas Bina Nusantara. Memiliki pengalaman dalam proyek ... . Saya memiliki minat berkarir dalam bidang mobile application, dan web development. Saya memiliki kemampuan dalam menggunakan bahasa C++, Java." class="w-full h-30 rounded pl-4 pt-2 pb-2"></textarea>
                    </div>
