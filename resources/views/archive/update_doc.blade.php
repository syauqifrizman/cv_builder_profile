...
@section('content')
    <div class="grid grid-cols-2 mt-6 mr-4 ml-4 mb-8 pt-16 gap-4">
        <div class="container-left">
                                ...
                                @foreach ($document->experience as $experience)
                                    <div class="rounded border border-sky-100 mb-4">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <input type="text" name="input" id="company_location" value="{{ $experience ? $experience->company_location : '' }}" placeholder="Insert the location of the company city, e.g. Jakarta Barat" class="w-full h-10 rounded pl-4">
                                        </div>
                                    ...
                                    <div class="rounded border border-sky-100 mb-4">
                                        <div class="mb-2">
                                            ...
                                            <div class="pl-6 w-full">
                                                <textarea name="description" id="other_description" class="w-full rounded pl-4 py-2 pr-2">{{ $skillOther->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
            ...
            {{-- <form action="{{url('builder.blade.php')}}" method="post" enctype="multipart/form-data" id="stepForm2">
                @csrf --}}
                    {{-- <div class="form-step hidden" id="step2">
                        <div class="bg-sky-50 mt-6 pr-6 pl-6 mb-6 rounded-md">
                            <div class="">
                            ...
                            <div class="bg-sky-50 mt-6 pr-6 pl-6 mb-6 rounded-md">
                                <div class="">
                                    ...
                                    <div class="rounded border border-sky-100 mb-4">
                                        <div class="mt-4">
                                            <label for="company_name" class="mb-2 block">Company Name</label>
                                            <input required type="text" name="input" id="company_name" placeholder="Insert company name, e.g. Tokopaedi" class="w-full h-10 rounded pl-4">
                                        </div>

                                        <div class="mt-4">
                                            <label for="company_position" class="mb-2 block">Your Position</label>
                                            <input type="text" name="input" id="position" placeholder="Insert your position in the company, e.g. Software Engineer" class="w-full h-10 rounded pl-4">
                                        </div>

                                        <div class="mt-4">
                                            <label for="company_location" class="mb-2 block">Company Location</label>
                                            <input type="text" name="input" id="company_location" placeholder="Insert the location of the company city, e.g. Jakarta Barat" class="w-full h-10 rounded pl-4">
                                        </div>

                                        <div class="mt-4">
                                            <label for="company_desc" class="mb-2 block">Company Description</label>
                                            <textarea rows="5" name="input" id="company_desc" placeholder="Please briefly describe your company, e.g. Tech-powered online grocery supply chain. Series C-funded ($139mio raised)" class="w-full h-20 rounded pl-4 pt-2 pb-2"></textarea>
                                        </div>

                                        <div class="mt-4 flex justify-between gap-6">
                                            <div class="w-1/2">
                                                <label for="company_start" class="mb-2 block">Start</label>
                                                <input type="date" name="input" id="company_start" class="w-full h-10 rounded pl-4">
                                            </div>

                                            <div class="w-1/2">
                                                <label for="company_end" class="mb-2 block">End</label>
                                                <input type="date" name="input" id="company_end" class="w-full h-10 rounded pl-4">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="">
                                                <div class="mb-2 flex items-center">
                                                    <div class="w-2 h-2 bg-black rounded-full mx-2"></div>
                                                    <div class="w-full">
                                                        <textarea name="description" id="experienceDescription" class="w-full rounded pl-4 py-2 pr-2"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
